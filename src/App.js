          ...
          <div>
            <nav>
              <ul className="container-navbar">
                <li>
                  <Link  className="btnlink" style={{ 'font-family': 'cursive', 'font-size': '20px' }} disabled>
                    FOODITE
                  </Link>
                </li>
                {!localStorage.getItem('Email') ? (
                  ...
                  <>
                    <li>
                      <Link title="Home" className="btnlink" to="/">
                    ...
                    <li>
                      <Link title="Cart" className="btnlink" to="/cart">
                    ...
                    <li>
                      <Link title="My Account" className="btnlink" to="/myaccount">
                    ...
                    <li>
                      <Link className="btnlink" to="/logout">
