...
function Home(props) {
  ...
  const restaurants = [
    {
      id: 0,
      Restaurant: 'Hyderabad Delight Restaurant',
    ...
    {
      id: 1,
      Restaurant: 'Taj Deccan Restaurant',
    ...
    {
      id: 2,
      Restaurant: 'Taj Krishna Restaurant',
    ...
    {
      id: 4,
      Restaurant: 'Cafe Bahar Restaurant',
      Discription:
      ...
      return (
        <Col xs={4} key={id}>
          <Card style={{ width: '18rem', marginTop: '20px' }}>
            <Card.Header as="h5" style={{ backgroundColor: '#1fcc7a', color: 'white', height: '60px', 'text-align': 'space-around' }}>
              {res.Restaurant}
            </Card.Header>
            <Card.Body>
